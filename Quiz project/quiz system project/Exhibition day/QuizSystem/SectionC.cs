...
namespace QuizSystem
{
    public partial class SectionC : Form
    {
        ...
        private void SectionC_Load(object sender, EventArgs e)
        {
            try
                {
            sq.test("C", q1, Q1a, Q1b, Q1c, Q1d,  q2, Q2a, Q2b, Q2c, Q2d,  q3, Q3a, Q3b, Q3c, Q3d,  q4, Q4a, Q4b, Q4c, Q4d, q5, Q5a, Q5b, Q5c, Q5d);
             }
            catch(Exception ex)
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SectionD secA = new SectionD(_min,_sec);
                secA.Show();
                this.Hide();
