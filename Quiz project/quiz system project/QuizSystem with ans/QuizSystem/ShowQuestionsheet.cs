...
namespace QuizSystem
{
    class ShowQuestionsheet
    {
      ...
      public int[] anss = new int[4];
      static int secnum = 0; 
        int temp = 0;
        string[] Questions_Answers = new string[5];

        public void test(string sec,Label q1,RadioButton Q1a,RadioButton Q1b,RadioButton Q1c,RadioButton Q1d,RadioButton Q1ans,Label q2,RadioButton Q2a,RadioButton Q2b,RadioButton Q2c,RadioButton Q2d,RadioButton Q2ans,Label q3,RadioButton Q3a,RadioButton Q3b,RadioButton Q3c,RadioButton Q3d,RadioButton Q3ans,Label q4,RadioButton Q4a,RadioButton Q4b,RadioButton Q4c,RadioButton Q4d,RadioButton Q4ans,Label q5,RadioButton Q5a,RadioButton Q5b,RadioButton Q5c,RadioButton Q5d,RadioButton Q5ans)
        {
            ...
            showquestions(q1, Q1a, Q1b, Q1c, Q1d, Q1ans);
            showquestions(q2, Q2a, Q2b, Q2c, Q2d, Q2ans);
            showquestions(q3, Q3a, Q3b, Q3c, Q3d, Q3ans);
            showquestions(q4, Q4a, Q4b, Q4c, Q4d, Q4ans);
            showquestions(q5, Q5a, Q5b, Q5c, Q5d, Q5ans);
        }
        ...
        public void showquestions(Label Quetions, RadioButton rd1, RadioButton rd2, RadioButton rd3, RadioButton rd4, RadioButton rd5)
        {
            ...
            rd5.Text = rn["correct_ans"].ToString();
